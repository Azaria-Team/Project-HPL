package hpl.world.blocks.defense.turret;
...
public class BlockRepairTurret extends Block {
    ...
    public float beamWidth = 1.2f, ringWidth = 5f;

    public TextureRegion baseRegion, laser, laserEnd, laserTop, laserTopEnd;

    public Color laserColor = HPLPal.lightningNodeColor, laserTopColor = Color.white.cpy();
    ...
    public class RepairTurretBuild extends Building{
        ...
        public void draw(){
            ...
            if(/*(target != null && Angles.angleDist(angleTo(target), rotation) < 30f) || */lastTarget != null && strength > 0.01f){
                ...
                float s = 8f;
                if(lastTarget instanceof Building b){
                    z = Layer.block;
        ...
        public void updateTile(){
            ...
            if(timer(timerTarget, 20)){
                target = Units.findAllyTile(team, x, y, r, Building::damaged);
